...
```
context/product.md    → roadmap, metrics, current state
context/company.md    → strategic priorities, decision makers, OKRs
...
If the PM isn't sure which artifact they need, use this guide:

| If the PM needs to... | Use |
|-----------------------|-----|
...
- **`pm-product-brief`**: Pitching a *new feature or initiative*. Includes effort sizing, MVP concept, phase breakdown, and explicit "what this is NOT". Use when you need resources for discovery or approval to write a PRD.
- **`pm-one-pager`**: Communicating *any type of recommendation*. Lighter, faster, no effort breakdown. Use for decisions, recommendations, or awareness — not just new features.
...
→ Arquivo sugerido: [context/product.md / context/company.md / goals.md / etc.]
...
Most communication requests need just one skill. The orchestrator identifies which and runs it directly.
